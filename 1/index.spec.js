import { calculateFuelForMass } from "./calculateFuelForMass";
...
describe("Day 1", function() {
  ...
  it("calculates sum of all fuel", function() {
    expect(calculateTotalFuel([14])).toBe(2);
    expect(calculateTotalFuel([1969])).toBe(966);
    expect(calculateTotalFuel([100756])).toBe(50346);
  });
});
